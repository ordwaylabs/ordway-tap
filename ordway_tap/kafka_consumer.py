...
from ordway_tap.record import invoice, subscription, customer, payment, credit, refund, billing_schedule,\
...
def listen_topic(state):
    ...
    consumer = KafkaConsumer(kafka_credentials['topic'], group_id=kafka_credentials['group_id'],
