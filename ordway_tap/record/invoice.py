...
def map_invoice_response(invoice_response):
    ...
    for invoice_line in invoice_lines:
        yield {
            ...
            'billing_contact': json.dumps(invoice_response.get('billing_contact')),
            'shipping_contact': json.dumps(invoice_response.get('shipping_contact')),
            ...
            'quantity': str(invoice_line.get('quantity')),
            'discount': str(invoice_line.get('discount')),
            'effective_price': invoice_line.get('effective_price'),
            'line_tax': invoice_line.get('line_tax'),
            'tax_lines': json.dumps(invoice_line.get('tax_lines')),
            'applied_tiers': json.dumps(invoice_line.get('applied_tiers')),
