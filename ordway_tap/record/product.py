...
def map_product_response(product_response):
    return {
        ...
        'order_journal_entry_enabled': product_response.get('order_journal_entry_enabled'),
        ...
        'invoice_journal_entry_enabled': product_response.get('invoice_journal_entry_enabled'),
        ...
        'revenue_journal_entry_enabled': product_response.get('revenue_journal_entry_enabled'),
