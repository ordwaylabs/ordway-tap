...
def map_payment_response(payment_response):
    return {
        ...
        'fee_amount': payment_response.get('fee_amount'),
        'applied_amount': payment_response.get('applied_amount'),
        'unapplied_amount': payment_response.get('unapplied_amount'),
        'refunded_amount': payment_response.get('refunded_amount'),
        ...
        'custom_fields': json.dumps(payment_response.get('custom_fields'))
    }
