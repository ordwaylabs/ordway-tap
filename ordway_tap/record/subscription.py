...
def map_subscription_response(subscription_response):
    ...
    for subscription_plan in subscription_plans:
        yield {
            ...
            "order_placed_at": format_date_string(
                subscription_response.get("order_placed_at")
            ),
            ...
            "cancellation_date": format_date_string(
                subscription_response.get("cancellation_date")
            ),
            ...
            "discounted_cmrr": convert_to_decimal(
                subscription_response.get("discounted_cmrr")
            ),
            ...
            "current_period_start_date": subscription_plan.get(
            ...
            "billing_period_start_alignment": subscription_plan.get(
            ...
            "backcharge_current_period": subscription_plan.get(
            ...
            "override_renewal_increment_percent": subscription_plan.get(
